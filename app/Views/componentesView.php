  ...
  <tbody>
    <?php
      foreach($componentes as $componente){
        echo "<tr>";
          echo "<td>".$componente->nomeMateria."<input type='checkbox' width='60'></td>";
          echo "<td>".$componente->diaHorario."<input type='checkbox' width='60'></td>";
          echo "<td>".$componente->curso."<input type='checkbox'  width='60'></td>";
          echo "<td>".$componente->horasSemanais."<input type='checkbox' align='right' ></td>";
        echo "</tr>";
      };
    ?>
  </tbody>
